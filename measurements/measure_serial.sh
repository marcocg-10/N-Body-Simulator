...
#SBATCH -J serial_bellos_durmientes     # Job name
#SBATCH -o serial_time.txt              # Stdout output file (%j expands to jobId)
...
perf stat prun bin/proyecto02 test/job003/job003.tsv 1
